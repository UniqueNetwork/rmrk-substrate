...
export default {
  ...
  PalletRmrkCoreEvent: {
    _enum: {
      ...
      NFTSent: {
        sender: 'AccountId32',
        recipient: 'RmrkTypesAccountIdOrCollectionNftTuple',
        collectionId: 'u32',
        nftId: 'u32',
  ...
  /**
   * Lookup40: rmrk_types::AccountIdOrCollectionNftTuple<sp_core::crypto::AccountId32>
   **/
  ...
  PalletRmrkEquipCall: {
    _enum: {
      ...
      equippable: {
        baseId: 'u32',
        slotId: 'u32',
        equippables: 'RmrkTypesEquippableList',
      },
      theme_add: {
        baseId: 'u32',
        theme: 'RmrkTypesTheme',
      },
      create_base: {
        baseType: 'Bytes',
        symbol: 'Bytes',
        parts: 'Vec<RmrkTypesPartType>'
      }
    }
  },
  /**
   * Lookup125: rmrk_types::EquippableList<frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup127: rmrk_types::Theme<frame_support::storage::bounded_vec::BoundedVec<T, S>, BoundedPropertyList>
   **/
  RmrkTypesTheme: {
    name: 'Bytes',
  ...
  /**
   * Lookup129: rmrk_types::ThemeProperty<frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup131: rmrk_types::PartType<frame_support::storage::bounded_vec::BoundedVec<T, S>, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  RmrkTypesPartType: {
    _enum: {
  ...
  /**
   * Lookup132: rmrk_types::FixedPart<frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  RmrkTypesFixedPart: {
    id: 'u32',
    z: 'u32',
  ...
  /**
   * Lookup133: rmrk_types::SlotPart<frame_support::storage::bounded_vec::BoundedVec<T, S>, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  RmrkTypesSlotPart: {
    id: 'u32',
  ...
  PalletRmrkCoreCall: {
    _enum: {
      ...
      send: {
        collectionId: 'u32',
        nftId: 'u32',
        newOwner: 'RmrkTypesAccountIdOrCollectionNftTuple',
      },
      accept_nft: {
        collectionId: 'u32',
        nftId: 'u32',
  ...
  /**
   * Lookup143: pallet_rmrk_market::pallet::Call<T>
   **/
  ...
  /**
   * Lookup144: pallet_uniques::pallet::Call<T, I>
   **/
  PalletUniquesCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup145: pallet_uniques::types::DestroyWitness
   **/
  ...
  /**
   * Lookup149: rmrk_substrate_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup152: pallet_template::pallet::Error<T>
   **/
  PalletTemplateError: {
    _enum: ['NoneValue', 'StorageOverflow']
  },
  /**
   * Lookup153: rmrk_types::BaseInfo<sp_core::crypto::AccountId32, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  RmrkTypesBaseInfo: {
    issuer: 'AccountId32',
    baseType: 'Bytes',
  ...
  /**
   * Lookup156: pallet_rmrk_equip::pallet::Error<T>
   **/
  ...
  /**
   * Lookup157: rmrk_types::CollectionInfo<frame_support::storage::bounded_vec::BoundedVec<T, S>, frame_support::storage::bounded_vec::BoundedVec<T, S>, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup158: rmrk_types::NftInfo<sp_core::crypto::AccountId32, sp_arithmetic::per_things::Permill, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  RmrkTypesNftInfo: {
  ...
  /**
   * Lookup160: rmrk_types::RoyaltyInfo<sp_core::crypto::AccountId32, sp_arithmetic::per_things::Permill>
   **/
  ...
  /**
   * Lookup164: rmrk_types::ResourceInfo<frame_support::storage::bounded_vec::BoundedVec<T, S>, frame_support::storage::bounded_vec::BoundedVec<T, S>, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup168: PhantomType::up_data_structs<rmrk_types::PropertyInfo<frame_support::storage::bounded_vec::BoundedVec<T, S>, frame_support::storage::bounded_vec::BoundedVec<T, S>>>
   **/
  PhantomTypeUpDataStructs: '[Lookup169;0]',
  /**
   * Lookup169: rmrk_types::PropertyInfo<frame_support::storage::bounded_vec::BoundedVec<T, S>, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup171: pallet_rmrk_core::pallet::Error<T>
   **/
  PalletRmrkCoreError: {
  ...
  /**
   * Lookup172: pallet_rmrk_market::types::ListInfo<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup174: pallet_rmrk_market::types::Offer<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup175: pallet_rmrk_market::pallet::Error<T>
   **/
  ...
  /**
   * Lookup176: pallet_uniques::types::ClassDetails<sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup179: pallet_uniques::types::InstanceDetails<sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup180: pallet_uniques::types::ClassMetadata<DepositBalance, StringLimit>
   **/
  ...
  /**
   * Lookup181: pallet_uniques::types::InstanceMetadata<DepositBalance, StringLimit>
   **/
  ...
  /**
   * Lookup187: sp_core::sr25519::Signature
   **/
  ...
  /**
   * Lookup191: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup192: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup193: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup196: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup197: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup198: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup199: rmrk_substrate_runtime::Runtime
   **/
