...
import type { FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, RmrkTypesAccountIdOrCollectionNftTuple, SpFinalityGrandpaAppPublic, SpRuntimeDispatchError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    rmrkCore: {
      ...
      NFTAccepted: AugmentedEvent<ApiType, [AccountId32, RmrkTypesAccountIdOrCollectionNftTuple, u32, u32]>;
      ...
      NFTSent: AugmentedEvent<ApiType, [AccountId32, RmrkTypesAccountIdOrCollectionNftTuple, u32, u32, bool]>;
