...
declare module '@polkadot/types/lookup' {
  ...
  export interface PalletRmrkCoreEvent extends Enum {
    ...
    readonly asNftSent: {
      readonly sender: AccountId32;
      readonly recipient: RmrkTypesAccountIdOrCollectionNftTuple;
      readonly collectionId: u32;
      readonly nftId: u32;
  ...
  /** @name RmrkTypesAccountIdOrCollectionNftTuple (40) */
  ...
  export interface PalletRmrkEquipCall extends Enum {
    ...
    readonly asEquippable: {
      readonly baseId: u32;
      readonly slotId: u32;
      readonly equippables: RmrkTypesEquippableList;
    } & Struct;
    readonly isThemeAdd: boolean;
    readonly asThemeAdd: {
      readonly baseId: u32;
      readonly theme: RmrkTypesTheme;
    } & Struct;
    readonly isCreateBase: boolean;
    readonly asCreateBase: {
      readonly baseType: Bytes;
      readonly symbol: Bytes;
      readonly parts: Vec<RmrkTypesPartType>;
    } & Struct;
    readonly type: 'ChangeBaseIssuer' | 'Equip' | 'Equippable' | 'ThemeAdd' | 'CreateBase';
  }

  /** @name RmrkTypesEquippableList (125) */
  ...
  /** @name RmrkTypesThemeProperty (129) */
  export interface RmrkTypesThemeProperty extends Struct {
    readonly key: Bytes;
    readonly value: Bytes;
  }

  /** @name RmrkTypesPartType (131) */
  ...
  export interface PalletRmrkCoreCall extends Enum {
    ...
    readonly asSend: {
      readonly collectionId: u32;
      readonly nftId: u32;
      readonly newOwner: RmrkTypesAccountIdOrCollectionNftTuple;
    } & Struct;
    ...
    readonly isAddResource: boolean;
    readonly asAddResource: {
      readonly collectionId: u32;
      readonly nftId: u32;
      readonly resourceId: Bytes;
    ...
    readonly type: 'MintNft' | 'CreateCollection' | 'BurnNft' | 'DestroyCollection' | 'Send' | 'AcceptNft' | 'RejectNft' | 'ChangeCollectionIssuer' | 'SetProperty' | 'LockCollection' | 'AddResource' | 'AcceptResource' | 'RemoveResource' | 'AcceptResourceRemoval' | 'SetPriority';
  }

  /** @name PalletRmrkMarketCall (143) */
  ...
  /** @name PalletUniquesDestroyWitness (145) */
  ...
  /** @name RmrkSubstrateRuntimeOriginCaller (149) */
  ...
  /** @name PalletSudoError (151) */
  export interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PalletTemplateError (152) */
  ...
  /** @name RmrkTypesCollectionInfo (157) */
  ...
  /** @name RmrkTypesNftChild (167) */
  export interface RmrkTypesNftChild extends Struct {
    readonly collectionId: u32;
    readonly nftId: u32;
  }

  /** @name PhantomTypeUpDataStructs (168) */
  export interface PhantomTypeUpDataStructs extends Vec<RmrkTypesPropertyInfo> {}

  /** @name RmrkTypesPropertyInfo (169) */
  export interface RmrkTypesPropertyInfo extends Struct {
    readonly key: Bytes;
    readonly value: Bytes;
  }

  /** @name PalletRmrkCoreError (171) */
  ...
  /** @name PalletRmrkMarketListInfo (172) */
  ...
  /** @name PalletRmrkMarketOffer (174) */
  ...
  /** @name PalletRmrkMarketError (175) */
  ...
  /** @name PalletUniquesClassDetails (176) */
  ...
  /** @name PalletUniquesInstanceDetails (179) */
  ...
  /** @name PalletUniquesClassMetadata (180) */
  ...
  /** @name PalletUniquesInstanceMetadata (181) */
  ...
  /** @name PalletUtilityError (184) */
  export interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name SpRuntimeMultiSignature (186) */
  ...
  /** @name SpCoreSr25519Signature (187) */
  export interface SpCoreSr25519Signature extends U8aFixed {}

  /** @name SpCoreEcdsaSignature (188) */
  export interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name FrameSystemExtensionsCheckSpecVersion (191) */
  export type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (192) */
  export type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (193) */
  export type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (196) */
  export interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (197) */
  export type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (198) */
  export interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name RmrkSubstrateRuntimeRuntime (199) */
