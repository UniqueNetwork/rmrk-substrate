...
import {
    RmrkTypesAccountIdOrCollectionNftTuple as NftOwner, RmrkTypesEquippableList as EquippableList, RmrkTypesPartType as PartType, RmrkTypesTheme as Theme
...
export async function createBase(
    ...
    const partTypes = api.createType("Vec<RmrkTypesPartType>", parts) as Vec<PartType>;
...
export async function setEquippableList(
    ...
    const issuer = privateKey(issuerUri);
    const equippable = api.createType('RmrkTypesEquippableList', equippableList) as EquippableList;
...
export async function addTheme(
    ...
    const issuer = privateKey(issuerUri);
    const theme = api.createType('RmrkTypesTheme', themeObj) as Theme;
